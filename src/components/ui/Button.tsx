...
const Button: FC<ButtonProps> = ({
  ...
  const variantStyles = {
    ...
    bordered: isDisabled
      ? "bg-white text-blue-300 border border-blue-300 cursor-not-allowed"
      : "bg-white text-blue-500 border border-blue-500 hover:bg-blue-50 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 cursor-pointer"
  };
    ...
    >
      {isLoading ? (
        <div className="flex items-center justify-center">
          <svg className={`animate-spin -ml-1 mr-2 h-4 w-4 ${variant === 'bordered' ? 'text-blue-500' : 'text-white'}`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
